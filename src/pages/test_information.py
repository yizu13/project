...
def test_information(page):
    ...
    confirm_button = ft.TextButton("Confirmar", on_click=lambda e: e_catalog.confirm_button_from_information_page(e,page,page_home_class_.text_name_doctor,page_home_class_.text_name_patient,page_home_class_.text_age_patient,page_home_class_.text_weight_patient))
