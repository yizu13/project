...
def text_fields(reason, confirm_button,page):
    ...
    patient_full_name = ft.TextField(text_align=ft.TextAlign.LEFT, label="Nombre completo del pasciente", on_change= lambda e: e_catalog.save_patient_name(e,confirm_button,page),border=ft.InputBorder.NONE, height=50)
